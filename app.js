...
const mockDocuments = {
    ...
    engineering: [
        ...
        },
        {
            ...
            summaryML: "ഫേസ് 3 വിപുലീകരണ പരിസ്ഥിതി അനുമതി കുറഞ്ഞ ആഘാതം തിരിച്ചറിഞ്ഞുകൊണ്ട് നന്നായി പുരോഗമിക്കുന്നു. ഗ്രീൻ ബിൽഡിംഗ് സ്റ്റാൻഡേർഡുകളും 3:1 വൃക്ഷം മാറ്റിസ്ഥാപിക്കൽ അനുപാതവുമുള്ള 11.2 കിമീ റൂട്ട് പദ്ധതിയിടുന്നു.",
            contentML: "കൊച്ചി മെട്രോയുടെ ഫേസ് 3 വിപുലീകരണത്തിനുള്ള പരിസ്ഥിതി അനുമതി അപേക്ഷയ്ക്ക് പരിസ്ഥിതി, വന, കാലാവസ്ഥാ വ‌ർത്തനാ മന്ത്രാലയത്തിൽ നിന്ന് പ്രാഥമിക അംഗീകാരം ലഭിച്ചു. കാക്കനാട്ടിൽ നിന്ന് അങ്കമാലി വരെയുള്ള നിർദ്ദിഷ്ട 11.2 കിമീ വിപുലീകരണത്തിൽ 9 സ്റ്റേഷനുകൾ ഉൾപ്പെട്ടിരിക്കുന്നു, ഇത് പ്രതിദിനം അനുകൂലമായി 60,000 അധിക യാത്രക്കാരെ സേവിക്കുമെന്ന് പ്രതീക്ഷിക്കുന്നു. വായു ഗുണനിലവാരം, ശബ്ദ മലിനീകരണം, ജല സ്രോതസ്സുകൾ, സസ്യജന്തുജാലങ്ങൾ, പ്രാദേശിക സമൂഹങ്ങളിലെ സാമൂഹിക-സാമ്പത്തിക ആഘാതം എന്നിവ ഉൾക്കൊള്ളുന്ന പരിസ്ഥിതി ആഘാത വിലയിരുത്തൽ പഠനങ്ങൾ പൂർത്തിയാക്കി.",
    ...
    safety: [
        {
            ...
            summaryML: "Q3 2024 സുരക്ഷാ ഓഡിറ്റ് CMRS മാനദണ്ഡങ്ങളുമായി 98.5% അനുസരണം കാണിക്കുന്നു. 4.2 മിനിറ്റ് ഒഴിപ്പിക്കൽ സമയവും 100% ട്രെയിൻ സംരക്ഷണ വിശ്വാസ്യതയുമൊത്ത് അടിയന്തിര സംവിധാനങ്ങൾ മികച്ച പ്രകടനം കാഴ്ചവയ്ക്കുന്നു.",
            contentML: "കമ്മീഷണർ ഓഫ് മെട്രോ റെയിൽവേ സേഫ്റ്റി (CMRS) നടത്തിയ Q3 2024-ലെ സമഗ്രമായ സുരക്ഷാ ഓഡിറ്റ് എല്ലാ സുരക്ഷാ പാരാമീറ്ററുകളിലും മൊത്തത്തിൽ തൃപ്തികരമായ റേറ്റിംഗുകളോടെ പൂർത്തിയാക്കി. സിഗ്നലിംഗ് സിസ്റ്റങ്ങൾ, അടിയന്തിര ഒഴിപ്പിക്കൽ നടപടിക്രമങ്ങൾ, അഗ്നി സുരക്ഷാ നടപടികൾ, പ്ലാറ്റ്ഫോം സുരക്ഷാ തടസ്സങ്ങൾ, ട്രെയിൻ സംരക്ഷണ സംവിധാനങ്ങൾ, സ്റ്റാഫ് സുരക്ഷാ പ്രോട്ടോക്കോളുകൾ എന്നിവയുൾപ്പെടെ 127 സുരക്ഷാ ചെക്ക് പോയിന്റുകൾ ഓഡിറ്റിൽ ഉൾപ്പെടുത്തി.",
            type: "Safety Audit"
        }
    ],
    legal: [
    ...
    admin: [
        {
            ...
            summaryML: "സെപ്റ്റംബർ 2024 ബോർഡ് മീറ്റിംഗിൽ മെയിന്റനൻസിനായി ₹25 കോടി, ഫേസ് 3 പരിസ്ഥിതി വിലയിരുത്തൽ, സാങ്കേതിക അപ്ഗ്രേഡുകൾ എന്നിവ അംഗീകരിച്ചു. ഫേസ് 2 വിപുലീകരണം 94% പൂർത്തിയായി, ഡിസംബർ ലോഞ്ച് ലക്ഷ്യമിട്ട്.",
            contentML: "2024 സെപ്റ്റംബർ 15-ന് മാനേജിംഗ് ഡയറക്ടറുടെ അധ്യക്ഷതയിൽ 8 ബോർഡ് അംഗങ്ങളുടെയും മുതിർന്ന ഉദ്യോഗസ്ഥരുടെയും പങ്കാളിത്തത്തോടെ കൊച്ചി മെട്രോ റെയിൽ ലിമിറ്റഡിന്റെ പ്രതിമാസ ബോർഡ് മീറ്റിംഗ് നടന്നു. പ്രവർത്തന പ്രകടനം, സാമ്പത്തിക സ്ഥിതി, ഫേസ് 2 വിപുലീകരണ പുരോഗതി, ഫേസ് 3 ആസൂത്രണ അനുമതികൾ എന്നിവയുടെ അവലോകനം പ്രധാന അജണ്ട ഇനങ്ങളിൽ ഉൾപ്പെടുന്നു.",
            type: "Board Minutes"
        }
    ]
};
